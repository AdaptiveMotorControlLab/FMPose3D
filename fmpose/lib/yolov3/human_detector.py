...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default=get_checkpoint_path('yolov3.weights'), 
    ...
    parser.add_argument('-i', '--image', type=str, default='lib/yolov3/data/dog-cycle-car.png',
