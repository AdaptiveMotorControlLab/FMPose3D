...
train_file=${data_path_prefix}/primate_data/samples/with_tail/${dataset_file}_test.json
test_file=${data_path_prefix}/primate_data/samples/with_tail/${dataset_file}_test.json
