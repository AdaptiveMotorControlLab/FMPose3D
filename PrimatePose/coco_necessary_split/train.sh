...
train_file="${data_path_prefix}/primate_data/splitted_${mode}_datasets/${dataset_name}_train_${mode}.json"
test_file="${data_path_prefix}/primate_data/splitted_test_datasets/${dataset_name}_train_test.json"
