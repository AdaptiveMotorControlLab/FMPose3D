...
def pycocotools_evaluation(
    ...
    try:
        ...
        print("kpt_oks_sigmas:", coco_eval.params.kpt_oks_sigmas)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--oks_sigma", type=str, default='0.1', help="OKS sigma values as comma-separated list (e.g., '0.1,0.1,0.1')")
    args = parser.parse_args()
    
    # Parse oks_sigma from string to list of floats
    if args.oks_sigma:
        args.oks_sigma = [float(sigma) for sigma in args.oks_sigma.split(',')]
    # print("oks_sigma:", args.oks_sigma)
    main(
        args.project_root,
        args.train_file,
        args.test_file,
