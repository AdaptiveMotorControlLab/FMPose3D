...
OUTPUT="/home/ti_wang/Ti_workspace/sapiens/primate_data/processed_images/depth"

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_0.3b';
CHECKPOINT=/home/ti_wang/Ti_workspace/sapiens/downloads/sapiens-depth-0.3b-torchscript/sapiens_0.3b_render_people_epoch_100_torchscript.pt2
# CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/depth/checkpoints/sapiens_0.3b/sapiens_0.3b_render_people_epoch_100_$MODE.pt2
...
# CHECKPOINT=/home/ti_wang/Ti_workspace/sapiens/downloads/sapiens-depth-1b-torchscript/sapiens_1b_render_people_epoch_88_torchscript.pt2
# CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/depth/checkpoints/sapiens_1b/sapiens_1b_render_people_epoch_88_$MODE.pt2
