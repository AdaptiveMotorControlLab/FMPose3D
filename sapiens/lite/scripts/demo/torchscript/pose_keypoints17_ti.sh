...
CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_0.3b/sapiens_0.3b_coco_best_coco_AP_796_$MODE.pt2
# MODEL_NAME='sapiens_pose_0.3b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_0.3b/sapiens_0.3b_goliath_best_goliath_AP_573_torchscript.pt2
...
JOBS_PER_GPU=1; TOTAL_GPUS=1; VALID_GPU_IDS=(0 1)
