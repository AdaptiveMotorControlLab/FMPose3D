...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.encoder_y_t = encoder(3, args.channel//2, args.channel - self.t_embed_dim)
    ...
    def forward(self, pose_2d, y_t, t):
        # y_t: (B,F,J,3)  t: (B,1,1,1) or (B,F,1,1)
        b, f, j, _ = y_t.shape
