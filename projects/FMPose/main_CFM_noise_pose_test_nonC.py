...
def step(split, args, actions, dataLoader, model, optimizer=None, epoch=None, steps=None):
    ...
    for i, data in enumerate(tqdm(dataLoader, 0)):
        ...
        if split =='train':
            ...
            def euler_sample(x2d, y_local, steps_local, guidance_scale=1.0):
                dt = 1.0 / steps_local
            ...
            y_s = euler_sample(input_2D_nonflip, y_noise, steps_to_use, guidance_scale=args.guidance_scale)
            if args.test_augmentation:
                ...
                y_flip_s = euler_sample(input_2D_flip, y_flip, steps_to_use, guidance_scale=args.guidance_scale)
                y_flip_s = y_flip_s
                y_flip_s[:, :, :, 0] *= -1
