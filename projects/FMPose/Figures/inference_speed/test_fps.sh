#!/bin/bash
# FPS Testing Script for FMPose (Parallel Version)
...
sh_file='FMPose_fps_test_parallel.sh'
...
echo "=================================="
echo "FMPose FPS Testing (Parallel)"
echo "=================================="
echo "GPU: ${gpu_id}"
...
python3 FMPose_fps_test_parallel.py \
--reload \
