...
exp_temp=0.005
flipaug=True
folder_name=exp_FlipAug_useSameNoiseforFlipedPose_flipedNoise_s${eval_multi_steps}_Top${topk}_${mode}_temp${exp_temp}_h${num_hypothesis_list}_noflipforNoise_test_results_$(date +%Y%m%d_%H%M%S)
