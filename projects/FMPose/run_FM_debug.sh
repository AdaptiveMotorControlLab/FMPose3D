#Train CFM
folder_name=FM_attention_x0_noise_layers6_lr1e-3_decay0.98_sample3_$(date +%Y%m%d_%H%M)
...
python3 main_CFM.py --train --model model_attention --gpu 0 --layers 6 --lr 1e-3 --lr_decay 0.98 --nepoch 100 --sample_steps 3 --folder_name $folder_name --debug
#Test CFM
