...
def aggregation_select_single_best_hypothesis_by_2D_error(
...
def aggregation_RPEA_weighted_by_2D_error(
    list_hypothesis, batch_cam, input_2D, gt_3D, topk=3
):
    """
    Select per-joint 3D from the hypothesis whose 2D projection yields minimal L2 error.
...
def test_multi_hypothesis(
    ...
    for i, data in enumerate(tqdm(dataLoader, 0)):
        ...
        for s_keep in eval_steps:
            ...
            output_3D_s = aggregation_RPEA_weighted_by_2D_error(
